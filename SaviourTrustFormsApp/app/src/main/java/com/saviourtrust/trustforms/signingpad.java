 ...
 * Use the {@link signingpad#newInstance} factory method to
...
public class signingpad extends Fragment {
     ...
     * @return A new instance of fragment signingpad.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(InitialAssessment7.this, "Signature Saved", Toast.LENGTH_SHORT).show();
            }
        });
